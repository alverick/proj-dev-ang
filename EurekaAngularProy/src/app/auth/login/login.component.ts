      ...
      .subscribe(
        value => {
          ...
          if(value.paramStr==="Un session ya se encuentra activa"){
            ...
            this.codigo2= false;
              ...
              Swal.fire({
               // type: tipo ,
                ...
                html: 'Estamos procesando la información de tu registro, esto puede tomar un máximo 24 horas hábiles. Cuando esté lista te enviaremos un mail de Bienvenida.',
                showCloseButton: true,
                showCancelButton: false,
                showConfirmButton: true,
                cancelButtonColor: '#d33',
            ...
            this.mensaje( 'error', 'Contraseña Incorrecta','Tu cuenta ha sido bloqueada por seguridad, inténtalo nuevamente en 60 minutos. Si tienes problemas para ingresar a tu cuenta, contáctanos a solucionesBPE@intercorp.com.pe '  );
            this.intento6= true;
            this.isTrue = false;
          }
        },
