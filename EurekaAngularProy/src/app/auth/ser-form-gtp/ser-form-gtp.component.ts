...
export class SerFormGtpComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.frm = this.fb.group({
      nombre: new FormControl({
        value: (this._service.nombre === '?') ? ((this._service.newName.substring(0, 3) === '???') ?
      ...
      codDeudor: new FormControl({
        value: (this._service.codDeudor === '?') ? this._service.newNameCode :
          ((this._service.codDeudor === 'RUC' || this._service.codDeudor === 'DNI' || this._service.codDeudor === 'Codigo Interno') ?
            this._service.codDeudor : 'Otro'), disabled: this._service.nombreCodHabilitado
      }, [Validators.required]),
      nameCod: new FormControl({
        value: (this._service.codDeudor === '?') ? this._service.newNameCode : (this._service.codDeudor == 'Otro') ?
