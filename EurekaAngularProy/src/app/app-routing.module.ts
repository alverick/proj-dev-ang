...
const routes: Routes = [
  ...
  { path: 'configuraCobrosParteDosAfiliacion', component: ConfiguraCobrosParteDosComponent, data: { isEdit: false, affiliationFlow: true }},
  { path: 'configuraCobrosParteDos', component: ConfiguraCobrosParteDosComponent, data: { isEdit: false, affiliationFlow: false }},
  { path: 'configuraCobrosParteTresAfiliacion', component: ConfiguraCobrosParteTresComponent, data: { isEdit: false, affiliationFlow: true}},
  { path: 'configuraCobrosParteTres', component: ConfiguraCobrosParteTresComponent, data: { isEdit: false, affiliationFlow: false }},
  { path: 'configuraCobrosParteCuatroAfiliacion', component: ConfiguraCobrosParteCuatroComponent, data: { isEdit: false, affiliationFlow: true }},
  { path: 'configuraCobrosParteCuatro', component: ConfiguraCobrosParteCuatroComponent, data: { isEdit: false, affiliationFlow: false }},
  { path: 'resumenCobrosAfiliacion', component: ResumenCobrosComponent, data: { isEdit: false, affiliationFlow: true }},
  { path: 'resumenCobros', component: ResumenCobrosComponent, data: { isEdit: true, affiliationFlow: false }},
  { path: 'editarCobrosAfiliacion', component: EditarCobrosComponent, data: { isEdit: true, affiliationFlow: true  }},
  { path: 'editarCobros', component: EditarCobrosComponent, data: { isEdit: true, affiliationFlow: false  }},
